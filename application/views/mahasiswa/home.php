				...
				<div class="row">
					<div class="col-md">
						<div class="nav nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
							...
							<a class="nav-item nav-link active" id="v-pills-home-tab" data-toggle="tab" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-envelope fa-sm"></i> Notifikasi 
							</a>

								<a class="nav-item nav-link <?= $_SESSION['Status'] == 'TugasAkhir' && !$tugasakhir ? '' : 'disabled'?>" id="navIdetugasakhir" data-toggle="tab" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"> <i class="fas fa-file-alt fa-sm"></i> Idea Concept Paper 
								</a>

								<a class="nav-item nav-link <?= $_SESSION['Status'] == 'TugasAkhir' && $tugasakhir ? '' : 'disabled'?>" id="navTugasAkhir" data-toggle="tab" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false" ><i class="fas fa-pencil-alt"></i> Tugas Akhir </a>
