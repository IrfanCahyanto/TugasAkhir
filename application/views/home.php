	...
	<div class="container col-md-5 col-11 col-sm-7" style="height: 100%; display: table;">
		<form id="form-login" action="<?=base_url('Home/session');?>" method="POST" style="vertical-align: middle; display: table-cell; ">
			<div class="card card-body">
				<h6> Sistem E-Control Tugas Akhir Jurusan Kriptografi</h6>
				<input name="nim" id="nim" type="text" class="form-control form-group" placeholder="NPM / NIP">
				<input name="password" id="password" type="password" class="form-control form-group" placeholder="Password">
				
					<small class="form-text text-muted mb-3"> Silahkan login terlebih dahulu agar dapat menggunakan sistem ini </small>
